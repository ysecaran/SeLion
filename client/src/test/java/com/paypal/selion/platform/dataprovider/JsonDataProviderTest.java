...
public class JsonDataProviderTest {
    ...
    public void jsonPojoParseByIndexTest() throws JsonDataProviderException {
        ...
        for (int i = 0; i < requestedData.length; i++) {
            ...
            case 1: {
                ...
                assertTrue(userData.getBank().getName().equals("Wells"));
                break;
            }
            case 2: {
                assertTrue(userData.getPhoneNumber().equals("908343781"));
    ...
    public void getDataAsHashTableTest() throws JsonDataProviderException, IOException {
        ...
        assertTrue(dataRequested.get("test1").get("accountNumber").equals("897065789541"));
        ...
        assertTrue(sample.get("name").equals("DBAG"));
    }
